...
<head>
    ...
    <meta charset="utf-8" />
    <title>Faculty- Peleza Admin</title>
...
<body class="no-skin">
    ...
    <div class="main-container" id="main-container">
            ...
            <div class="main-content-inner">
                ...
                <div class="breadcrumbs" id="breadcrumbs">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="#">Faculty Manager</a>
                        </li>


                        <li class="active">Faculty Data</li>
                    </ul><!-- /.breadcrumb -->
                ...
                <div class="page-content" id="faculty">
                    ...
                    <div class="row background-container">
                        <div class="col-xs-12">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <h3 align="left" class="header smaller lighter blue">FACULTY DATA</h3>
                                    </div>
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="input-group">
                                                            ...
                                                            <span class="input-group-btn">
                                                                ...
                                                                <button data-target="#add-institution" data-toggle="modal" type="button" class="btn btn-info">Add Faculty</button>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>

                                                <vuetable ref="vuetable" api-url="/v1/faculty_api.php" :fields="fields" :sort-order="sortOrder" :css="css.table" pagination-path="" :per-page="perPage" :append-params="moreParams" @vuetable:pagination-data="onPaginationData" @vuetable:loading="onLoading" @vuetable:loaded="onLoaded">
                    ...
                    <div class="modal fade" id="add-institution" tabindex="-1" role="dialog" aria-labelledby="add-institution" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Add New Faculty <span style="display: none" id="added_by"><?php echo$_SESSION['MM_full_names']; ?></span></h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="faculty_name" placeholder="Name of Faculty" v-model="faculty_name">
                                        </div>

                                        <div class="form-group col-md-12">
                                            <label for="student_reg_number">Faculty Code</label>
                                            <input type="text" class="form-control" id="faculty_code" placeholder="Faculty Code" v-model="faculty_code">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal fade" id="edit-faculty" tabindex="-1" role="dialog" aria-labelledby="edit-faculty" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Edit <span v-text="faculty.faculty_name"></span> <span style="display: none" id="added_by"><?php echo     $_SESSION['MM_full_names']; ?></span></h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label for="data_source">Name</label>
                                            <input type="text" class="form-control" id="faculty_name" placeholder="Name of Faculty" v-model="faculty.faculty_name">
                                        </div>

                                        <div class="form-group col-md-12">
                                            <label for="student_reg_number">Faculty Code</label>
                                            <input type="text" class="form-control" id="faculty_code" placeholder="Faculty Code" v-model="faculty.faculty_code">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <button type="button" class="btn btn-primary" @click="updateFaculty">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="../../v1/js/faculty.js?<?= rand(1, 1000) ?>"></script>
