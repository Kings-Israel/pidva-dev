                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="input-group">
                                                            ...
                                                            <span class="input-group-btn">
                                                                ...
                                                                <button data-target="#add-course" data-toggle="modal" type="button" class="btn btn-info">Add Course</button>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>

                                                <vuetable ref="vuetable" api-url="/v1/course_api.php" :fields="fields" :sort-order="sortOrder" :css="css.table" pagination-path="" :per-page="perPage" :append-params="moreParams" @vuetable:pagination-data="onPaginationData" @vuetable:loading="onLoading" @vuetable:loaded="onLoaded">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="course_name" placeholder="Name of Course" v-model="course_name">
                                        </div>

                                        <div class="form-group col-md-12">
                                            <label for="student_reg_number">Course Code</label>
                                            <input type="text" class="form-control" id="course_code" placeholder="Course Code" v-model="course_code">
                                        </div>
