...
class AuthMailer
{
    ...
    public function send_mail(
        ...
        // $mail->SMTPAuth = true;                     // Enable SMTP authentication
        // $mail->Username = '73d64b1c06a9e4';         // SMTP username
        // $mail->Password = 'ac938b858998db';         // SMTP password
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td class="content-block">
                                                            ...
                                                            <p>Thanks for choosing Peleza! We are thrilled to have you on board.</p>
                                                            <p>Below are your system generated credentials. Please <strong>change the password</strong> immediately after successful login. </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="content-block" style="padding: .6rem; font-family: monospace;"
                                                            ...
                                                            <blockquote
                                                                ...
                                                                <p>Client Login ID: '.$client_company_id.'</p>
                                                    ...
                                                    <tr align="center">
                                                        <td class="content-block" style="vertical-align:top; padding:0 0 20px"
                                                            valign="top"> <a href="https://dev.portal.pidva.africa" class="btn-primary"
