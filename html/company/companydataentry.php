...
-->
                         ...
                         <button class="btn btn-white btn-info btn-bold">
                                ...
                                <h3 align="left" class=" smaller lighter blue"><strong>SEARCH
                                        REF: </strong> <?php echo $row_getstudent[
                                            'request_ref_number'
                                        ]; ?></h3>
                                ...
                                <div>
                                    <table id="simple-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <a href="#"><?php echo $row_getstudent[
                                                        'bg_dataset_name'
                                                    ]; ?></a>
                                                </td>
                                                    ...
                                                    $totalRows_getfiles2 > 0
                                                        ...
                                                        <table id="simple-table" class="table  table-bordered table-hover">
                                                            <?php do { ?>
                                                                <tr>
                                                                    <td width="35%">
                                                                        <b><?php echo $row_getfiles2[
                                                                            'psmtfile_type'
                                                                        ]; ?>
                                                                            :</b>
                                                                    </td>
                                                                    <td><?php echo $row_getfiles2[
                                                                        'psmtfile_name'
                                                                    ]; ?></td>
                                                                </tr>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form  action="<?php echo $invalidurl; ?>" class="form-horizontal" name="newinvalidremarks">
													...
													<input type="hidden" id="added_by" name="added_by" value="<?php echo $_SESSION[
                 'MM_full_names'
             ] .
                 '(' .
                 $_SESSION['MM_USR_EMAIL'] .
                 ')'; ?>" />
													<input type="hidden" id="added_date" name="added_date" value="<?php echo date(
                 'd-m-Y H:m:s'
             ); ?>" />
