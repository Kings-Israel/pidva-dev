...
if (!function_exists('GetSQLValueString')) {
    function GetSQLValueString(
        ...
        $theValue = function_exists('mysqli_real_escape_string')
            ? mysqli_real_escape_string($connect, $theValue)
            : mysqli_escape_string($connect, $theValue);
...
<body class="no-skin">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <?php
                                $query_getstudent =
                                    'SELECT * FROM pel_psmt_request WHERE request_id = ' .
                                    $colname_getrequestid .
                                    '';
                                ($getstudent = mysqli_query_ported(
                                    $query_getstudent,
                                    $connect
                                )) or die(mysqli_error($connect));
                                $row_getstudent = mysqli_fetch_assoc(
                                    $getstudent
                                );
                                $totalRows_getstudent = mysqli_num_rows(
                                    $getstudent
                                );

                                $refnumber2 =
                                    $row_getstudent['request_ref_number'];

                                mysqli_select_db($connect, $database_connect);
                                $query_getgetprogress_update = sprintf(
                                    "SELECT pel_psmt_request_modules.`status`
                                    FROM pel_module
                                    Inner Join pel_psmt_request_modules ON pel_psmt_request_modules.module_id = pel_module.module_id 
                                    WHERE pel_psmt_request_modules.request_ref_number = %s AND pel_psmt_request_modules.status = '11'",
                                    GetSQLValueString($refnumber2, 'text')
                                );

                                ($getgetprogress_update = mysqli_query_ported(
                                    $query_getgetprogress_update,
                                    $connect
                                )) or die(mysqli_error($connect));
                                $row_getgetprogress_update = mysqli_fetch_assoc(
                                    $getgetprogress_update
                                );
                                $totalRows_getgetprogress_update = mysqli_num_rows(
                                    $getgetprogress_update
                                );
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    <table id="simple-table" class="table  table-bordered table-hover">
                                                        ...
                                                        ($getprogress2 = mysqli_query_ported(
                                                            $query_getprogress2,
                                                            $connect
                                                        )) or
                                                            die(mysqli_error(
                                                        ...
                                                        $row_getprogress2 = mysqli_fetch_assoc(
                                                            $getprogress2
                                                        );
                                                        $totalRows_getprogress2 = mysqli_num_rows(
                                                            $getprogress2
                                                        );
                                                        $complete = 0;
                                                        $all = 0;
                                                        if (
                                                            $totalRows_getprogress2 >
                                                            0
                                                        ) {
                                                            $i = 1;
                                                            do { ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href="<?php echo $url; ?>" class="orange">
                                                                            <button class="btn btn-xs btn-info" <?php echo $url ==
                                                                                                                    '#'
                                                                                                                    ? "data-toggle='modal' data-target='#modal-add-reginfo-first'"
                                                                                                                    : ''; ?>>
                                                                    ...
                                                                    <td>
                                                                        <?php $invalidurl = show(
                                                                            ...
                                                                            : '#'; ?>
                                                                        <a href="#modal-invalidremarks" role="button" class="green" data-toggle="modal">
    ...
    <div id="modal-add-reginfo-first" class="modal fade" tabindex="-10">
    ...
    <div id="modal-invalidremarks" class="modal fade" tabindex="-10">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    <form action="<?php echo $invalidurl; ?>" class="form-horizontal" name="newinvalidremarks">
                        <input type="hidden" id="status" name="status" value="55" />
                        ...
                        <input type="hidden" id="company_name" name="company_name" value="invalid" />
                        <input type="hidden" id="company_code" name="company_code" value="invalid" />
                        <input type="hidden" id="company_email_address" name="company_email_address" value="invalid" />
                        <input type="hidden" id="company_mobile_number" name="company_mobile_number" value="invalid" />
                        <input type="hidden" id="company_country" name="company_country" value="invalid" />
                        <input type="hidden" id="company_industry" name="company_industry" value="invalid" />
                        <input type="hidden" id="company_logo" name="company_logo" value="invalid" />

                        <div class="space-10"></div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-pass1">Enter Remarks</label>
                            <div class="col-sm-9">
                                <span id="sprytextfield5">
                                    <textarea id="review_comments" name="review_comments"></textarea>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                                <button onClick="submitForm(event)" type="button" class="btn btn-info" data-dismiss="modal">
    ...
    <script type="text/javascript">
        function submitForm(event) {
            ...
            // Capture form values and create JSON object
            var formData = {
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('form[name="newinvalidremarks"]').submit(function(event) {
                event.preventDefault();
    ...
    <script type="text/javascript">
        $(document).on('click', '#invalid-button', function(event) {
            event.preventDefault();
                                                                ...
                                                                do { ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <strong>
                                                                                <?php 
                                                                                    if ($row_getprogress2['module_name']) {
                                                                                        echo $row_getprogress2['module_name'];
                                                                                    } else {
                                                                                        echo 'No Module';
                                                                                    } 
                                                                        ...
                                                                        <td class="hidden-480">
                                                                            <?php if ($row_getprogress2['status'] == '44') {
                                                                                echo '<span class="label label-sm label-warning">In Progress</span>';
                                                                        ...
                                                                        <td>
                                                                            <?php $url = show($row_getprogress2['module_id'])
                                                                                ? sprintf(
                                                                                    '%s.php?request_id=%s&moduleid=%s',
                                                                                    $row_getprogress2['module_role'],
                                                                                    $row_getstudent['request_id'],
                        ...
                        <form action="<?php echo $invalidurl; ?>" class="form-horizontal" name="newinvalidremarks">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9"><span id="sprytextfield5">
                                        <input type="text" id="review_comments" name="review_comments" />
                                        <span class="textfieldRequiredMsg">*</span></span></div>
                            </div>
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button onClick="submitForm" type="button" id="invalid-button" class="btn btn-info">
                                        <i class="ace-icon fa fa-check bigger-110"></i>
                                        Save
                                    </button>
                                    Â  Â 
