...
<head>
    ...
    <meta charset="utf-8" />
    <title>Company Modules Data Management - Peleza Admin</title>
                            ...
                            <div class="row">
                                ...
                                <?php
                                    if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminst")) {
                                        ...
                                        // $query_getstudent = "SELECT * FROM pel_psmt_request WHERE status IN ('', '33','44','77','00', '66') AND verification_status IN ('44','22','33','00', '66') AND  request_type LIKE '%COMPANY%' AND request_id >=1 " . $queryitem . "";
