...
var columns = [
  ...
  },
  {
    name: "added_by",
    title:
      '<span class="navy-blue glyphicon glyphicon-certificate"></span> Added By',
    sortField: "added_by",
  },
  {
    name: "added_date",
...
var vmDashboard = new Vue({
  ...
  data: {
    ...
    sortOrder: [{ field: "faculty_id", direction: "desc" }],
    faculty_name: "",
    faculty_code: "",
    added_by: added_by,
    faculty: {},
